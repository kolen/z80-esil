...
(def opcodes
  {nil
   (partial-opcodes nil)
   :fd
   (into [] (map (partial-opcodes :fd) (converters :fddd)))
   :dd
   (into [] (map (partial-opcodes :dd) (converters :fddd)))
   :ed
   (into [] (map (partial-opcodes :ed) (converters :ed)))
   :ddcb
   (into [] (map (partial-opcodes :ddcb) (converters :index)))
   :fdcb
   (into [] (map (partial-opcodes :fdcb) (converters :index)))})
